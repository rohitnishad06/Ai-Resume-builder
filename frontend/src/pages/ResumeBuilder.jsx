...
try {
  ...
  const saveResume = async () => {
    try {
      ...
      // resume img  from updated resume data   
  ...
  width: `${(activeSectionIndex * 100) / (sections.length - 1)}%`,
              ...
              <div className="space-y-6">
                    ...
                    {activesection.id === 'summary' && (
                      <ProfessionalSummayForm data={resumeData.professional_summary} onChange={(data) => SetResumeData(prev => ({...prev, professional_summary:data}))} SetResumeData={SetResumeData}/>
                    )}
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
                    <div className="relative w-full">
                      <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                        ...
                        <button onClick={chnageResumeVisibility} className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg ring-purple-300 hover:ring transition-colors">
                        ...
                        <button onClick={downloadResume} className="flex items-center py-2 px-6 gap-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 rounded-lg ring-green-300 hover:ring transition-colors">
                           <DownloadIcon className="sixe-4"/> Download
                        </button>
                      </div>
                    </div>
