  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      <div className="flex items-center gap-2 text-sm text-green-600 bg-blue-400/10  rounded-full px-6 py-1.5">
        ...
        <Title title='Build Your Resume' description='Our Streamlined Process Help you create a professional resume in minutes with intelligent AI-Powered tool and features.'/>
